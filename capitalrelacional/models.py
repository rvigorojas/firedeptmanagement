...
class Position(models.Model):
    ...
    person = models.ForeignKey(RelationalPerson, on_delete=models.CASCADE, verbose_name=u"Persona")
    company = models.ForeignKey(RelationalCompany, on_delete=models.CASCADE, verbose_name=u"Compania")
...
class Relationship(models.Model):
    ...
    relational_person = models.ForeignKey(RelationalPerson, on_delete=models.CASCADE,  verbose_name = u'Persona Relacionada', null=True, blank=True)
    firefighter = models.ForeignKey(Firefighter, on_delete=models.CASCADE,  verbose_name = u'Bombero Relacionado', null=True, blank=True )
    observation = models.TextField(verbose_name = u'Observación', null=True, blank=True)
