...
from capitalrelacional.models import RelationalPerson, RelationalCompany, Relationship, Position
from common.admin import CompanyTelephoneNumberInline, PersonTelephoneNumberInline
