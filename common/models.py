...
class Address(models.Model):
    ...
    city = models.ForeignKey(City, on_delete=models.CASCADE, verbose_name=u'Ciudad', null=True, blank=True)
...
class Degree(models.Model):
    ...
    school = models.ForeignKey(School, on_delete=models.CASCADE, verbose_name=u'Institución')
...
class Company(models.Model):
    ...
    name = models.CharField(verbose_name=u'Nombre', max_length=100)
    address = models.ForeignKey(Address, on_delete=models.CASCADE, null=True, blank=True, verbose_name='Dirección')
...
class PersonTelephoneNumber(models.Model):
    ...
    person = models.ForeignKey(BasePerson, on_delete=models.CASCADE)
    type = models.CharField(verbose_name=u'Tipo', max_length=1, choices=TELEPHONE_TYPE_CHOICES, default='O')
    telephone_number = models.ForeignKey(TelephoneNumber, on_delete=models.CASCADE)
...
class Person(BasePerson):
    ...
    birth_place = models.OneToOneField(Address, on_delete=models.CASCADE, related_name='born_here', verbose_name='Lugar de Nacimiento', null=True, blank=True)
...
class PersonAddress(models.Model):
    ...
    person = models.ForeignKey(Person, on_delete=models.CASCADE, verbose_name=u'Persona')
    address = models.ForeignKey(Address, on_delete=models.CASCADE, verbose_name=u'Dirección')
...
class PersonDegree(models.Model):
    ...
    person = models.ForeignKey(Person, on_delete=models.CASCADE, verbose_name=u'Persona')
    degree = models.ForeignKey(Degree, on_delete=models.CASCADE, verbose_name=u'Estudio')
...
class PersonCourse(models.Model):
    ...
    person = models.ForeignKey(Person, on_delete=models.CASCADE, verbose_name=u'Persona')
    training_course = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name=u'Curso')
...
class PersonJob(models.Model):
    ...
    person = models.ForeignKey(Person, on_delete=models.CASCADE, verbose_name=u'Persona')
    job = models.ForeignKey(Job, on_delete=models.CASCADE, verbose_name=u'Trabajo')
    start_date = models.DateField(verbose_name=u'Fecha de Inicio')
    end_date = models.DateField(verbose_name=u'Fecha de Finalización', null=True, blank=True)
    supervisor = models.ForeignKey(BasePerson, on_delete=models.CASCADE, null=True, blank=True, related_name='supervised_set', verbose_name='Supervisor')
